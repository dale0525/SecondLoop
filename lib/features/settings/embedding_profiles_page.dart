...
class EmbeddingProfilesPage extends StatefulWidget {
  const EmbeddingProfilesPage({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: [
                    DropdownMenuItem(
                      ...
                      child: Text(
                        context.t.embeddingProfiles.providers.openaiCompatible,
                      ),
                    ),
                  ],
                  onChanged: _busy
                ...
                FilledButton(
                  ...
                  child: Text(context.t.embeddingProfiles.actions.saveActivate),
                ),
                if (_error != null) ...[
                  const SizedBox(height: 12),
                  Text(
