...
class _StringsAttachmentsEn {
  ...
  late final _StringsAttachmentsProcessingEn processing =
      _StringsAttachmentsProcessingEn._(_root);
...
class _StringsSettingsEn {
  ...
  late final _StringsSettingsKnowledgeIndexEn knowledgeIndex =
      _StringsSettingsKnowledgeIndexEn._(_root);
  late final _StringsSettingsMigrationArchiveEn migrationArchive =
      _StringsSettingsMigrationArchiveEn._(_root);
}
...
// Path: attachments.processing
class _StringsAttachmentsProcessingEn {
  _StringsAttachmentsProcessingEn._(this._root);
  ...
  String get generatingKeyframes => 'Generating keyframes…';
  String get extractingAudio => 'Extracting audio track…';
  String get transcodingAudio => 'Preparing audio…';
  String get finalizingAttachment => 'Finalizing attachment…';
  String get waitingForSpeechRecognition => 'Waiting for speech recognition…';
  String get transcribingAudio => 'Transcribing audio…';
  String get understandingKeyframes => 'Understanding keyframes…';
  String get recognizingText => 'Recognizing text…';
  String get analyzingImage => 'Analyzing image…';
  String get analyzingAttachment => 'Analyzing attachment…';
}
...
class _StringsSettingsUpdateNoticeEn {
  ...
  String manualDownload({required Object version}) =>
      'New version ${version} is available. Download the MSI or open the release page.';
}
...
class _StringsSettingsExternalImportEn {
  ...
  String get chooseZipExport => 'Choose zip file';
  ...
  String get title => 'Import Markdown Data';
  String get introTitle => 'Readonly import for generic Markdown data';
  String get introBody =>
      'Choose a folder or zip file to recursively scan Markdown files and their referenced attachments. Imported content participates in retrieval only and never writes back to the source data.';
  String get sourceSectionTitle => '1. Choose Markdown import source';
  ...
  String get importedBatches => 'Markdown import batches';
  String get noImportBatchesYet => 'No Markdown import batches yet.';
  String get batchId => 'Batch ID';
  String get createdAt => 'Created at';
  String get updatedAt => 'Updated at';
  String get completedAt => 'Completed at';
  String get importingTitle => 'Importing Markdown data';
  ...
  String get reportTitle => 'Markdown import report';
...
// Path: settings.knowledgeIndex
class _StringsSettingsKnowledgeIndexEn {
  _StringsSettingsKnowledgeIndexEn._(this._root);

  final Translations _root; // ignore: unused_field

  // Translations
  String get title => 'Knowledge Index';
  String get subtitle =>
      'Build and diagnose the local unified knowledge index.';
  late final _StringsSettingsKnowledgeIndexStatusEn status =
      _StringsSettingsKnowledgeIndexStatusEn._(_root);
  late final _StringsSettingsKnowledgeIndexActionsEn actions =
      _StringsSettingsKnowledgeIndexActionsEn._(_root);
  String get versionSummaryUnavailable => 'Version summary unavailable';
  String versionSummary(
          {required Object schema,
          required Object normalization,
          required Object segmentation,
          required Object embedding,
          required Object retrieval}) =>
      'Versions — schema: ${schema}, normalization: ${normalization}, segmentation: ${segmentation}, embedding: ${embedding}, retrieval: ${retrieval}';
  String lastBuild({required Object value}) =>
      'Last successful build: ${value}';
  String staleReason({required Object value}) => 'Stale reason: ${value}';
  String lastError({required Object value}) => 'Last error: ${value}';
  String progress(
          {required Object documentsIndexed,
          required Object totalDocuments,
          required Object unitsIndexed,
          required Object embeddingsIndexed}) =>
      'Progress — documents: ${documentsIndexed}/${totalDocuments}, units: ${unitsIndexed}, embeddings: ${embeddingsIndexed}';
  late final _StringsSettingsKnowledgeIndexDebugEn debug =
      _StringsSettingsKnowledgeIndexDebugEn._(_root);
}

// Path: settings.migrationArchive
class _StringsSettingsMigrationArchiveEn {
  _StringsSettingsMigrationArchiveEn._(this._root);

  final Translations _root; // ignore: unused_field

  // Translations
  String get title => 'Migration archive';
  String get subtitle =>
      'Export a portable zip or replace this vault from an archive.';
  String get introTitle => 'Lossless cross-device migration';
  String get introBody =>
      'Export the current vault as a zip archive with Markdown, attachments, and manifest metadata. Importing an archive first creates a local rollback snapshot, then clears the current vault before restoring the archive.';
  String get exportSectionTitle => 'Export current vault';
  String get exportDialogTitle => 'Save migration archive';
  String get exportAction => 'Export zip archive';
  String get importSectionTitle => 'Import migration archive';
  String get importDialogTitle => 'Choose migration archive';
  String get importPickArchive => 'Choose zip archive';
  String get importAction => 'Clear and import archive';
  String get schemaVersion => 'Schema version';
  String get archiveItems => 'Items';
  String get archiveAttachments => 'Attachments';
  String get exportedAt => 'Exported at';
  String get destructiveConfirmTitle =>
      'I understand this will clear current vault data first';
  String get destructiveConfirmBody =>
      'The app will create a local rollback snapshot, then delete current vault data before importing the selected archive. This is not a merge operation.';
  String get progressTitle => 'Current progress';
  String get progressOperation => 'Operation';
  String get progressStage => 'Stage';
  String get progressStatus => 'Status';
  String get progressStep => 'Step';
  String get operationExport => 'Export';
  String get operationImport => 'Import';
  String get statusInProgress => 'In progress';
  String get statusCompleted => 'Completed';
  String get statusRollback => 'Rollback';
  String get stagePreparing => 'Preparing archive';
  String get stageCollecting => 'Collecting data';
  String get stageWritingMarkdown => 'Writing Markdown';
  String get stageCopyingAttachments => 'Copying attachments';
  String get stageZipping => 'Creating zip archive';
  String get stageCompleted => 'Completed';
  String get stageSnapshotCreated => 'Rollback snapshot created';
  String get stageVaultCleared => 'Vault cleared';
  String get stageBaseItemsRestored => 'Base items restored';
  String get stageAttachmentsRestored => 'Attachments restored';
  String get stageRelationsRestored => 'Relations restored';
  String get stageReindexCompleted => 'Reindex completed';
  String get stageRollback => 'Rollback restored';
  String get archiveSize => 'Archive size';
  String get confirmInputLabel => 'Type IMPORT to continue';
  String get confirmInputHint => 'Enter IMPORT';
}
...
class _StringsSettingsAboutStatusEn {
  ...
  // Translations
  String get idle =>
      'Check for updates. Linux can auto-update and restart; Windows uses manual MSI or release-page install.';
  ...
  String availableExternal({required Object version}) =>
      'Update available (${version}). Please install the MSI or use the release page manually.';
...
// Path: settings.knowledgeIndex.status
class _StringsSettingsKnowledgeIndexStatusEn {
  _StringsSettingsKnowledgeIndexStatusEn._(this._root);

  final Translations _root; // ignore: unused_field

  // Translations
  String get loading => 'Status: loading…';
  String get empty => 'Status: not built yet';
  String get running => 'Status: rebuilding';
  String get stale => 'Status: rebuild recommended';
  String get failed => 'Status: rebuild failed';
  String get cancelled => 'Status: rebuild cancelled';
  String get complete => 'Status: up to date';
}

// Path: settings.knowledgeIndex.actions
class _StringsSettingsKnowledgeIndexActionsEn {
  _StringsSettingsKnowledgeIndexActionsEn._(this._root);

  final Translations _root; // ignore: unused_field

  // Translations
  String get rebuild => 'Rebuild index';
  String get cancel => 'Cancel rebuild';
}

// Path: settings.knowledgeIndex.debug
class _StringsSettingsKnowledgeIndexDebugEn {
  _StringsSettingsKnowledgeIndexDebugEn._(this._root);

  final Translations _root; // ignore: unused_field

  // Translations
  String indexedDocuments({required Object visible, required Object total}) =>
      'Indexed documents (${visible}/${total})';
  String get memorySynthesisTitle => 'Memory synthesis';
  String get memorySynthesisBody =>
      'Generated memories stay local and encrypted inside the knowledge index.';
  late final _StringsSettingsKnowledgeIndexDebugChipsEn chips =
      _StringsSettingsKnowledgeIndexDebugChipsEn._(_root);
  late final _StringsSettingsKnowledgeIndexDebugDetailEn detail =
      _StringsSettingsKnowledgeIndexDebugDetailEn._(_root);
}
...
class _StringsAttachmentsContentVideoInsightsDetailEn {
  ...
  String groupedVideoHint({required Object count}) =>
      '${count} segments are grouped into one logical video entry.';
  String get derivedAssetsHint =>
      'Derived assets stay grouped under the same video entry.';
}
...
// Path: settings.knowledgeIndex.debug.chips
class _StringsSettingsKnowledgeIndexDebugChipsEn {
  _StringsSettingsKnowledgeIndexDebugChipsEn._(this._root);

  final Translations _root; // ignore: unused_field

  // Translations
  String total({required Object count}) => 'Total ${count}';
  String generated({required Object count}) => 'Generated ${count}';
  String source({required Object count}) => 'Source ${count}';
  String summaries({required Object count}) => 'Summaries ${count}';
  String preferences({required Object count}) => 'Preferences ${count}';
  String profiles({required Object count}) => 'Profiles ${count}';
  String events({required Object count}) => 'Events ${count}';
  String patterns({required Object count}) => 'Patterns ${count}';
  String usageRows({required Object count}) => 'Usage rows ${count}';
}

// Path: settings.knowledgeIndex.debug.detail
class _StringsSettingsKnowledgeIndexDebugDetailEn {
  _StringsSettingsKnowledgeIndexDebugDetailEn._(this._root);

  final Translations _root; // ignore: unused_field

  // Translations
  String generatedMemoryRetrieval({required Object value}) =>
      'Generated memory retrieval: ${value}';
  String hotnessRerank({required Object value}) => 'Hotness rerank: ${value}';
  String sessionDigest({required Object value}) => 'Session digest: ${value}';
  String lastSynthesis({required Object value}) => 'Last synthesis: ${value}';
  String lastUsageUpdate({required Object value}) =>
...
class _StringsAttachmentsZhCn extends _StringsAttachmentsEn {
  ...
  @override
  late final _StringsAttachmentsProcessingZhCn processing =
      _StringsAttachmentsProcessingZhCn._(_root);
  @override
...
class _StringsSettingsZhCn extends _StringsSettingsEn {
  ...
  @override
  late final _StringsSettingsKnowledgeIndexZhCn knowledgeIndex =
      _StringsSettingsKnowledgeIndexZhCn._(_root);
  @override
  late final _StringsSettingsMigrationArchiveZhCn migrationArchive =
      _StringsSettingsMigrationArchiveZhCn._(_root);
}
...
// Path: attachments.processing
class _StringsAttachmentsProcessingZhCn
    extends _StringsAttachmentsProcessingEn {
  _StringsAttachmentsProcessingZhCn._(_StringsZhCn root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get transcodingVideo => '正在转码视频…';
  @override
  String get generatingKeyframes => '正在生成关键帧…';
  @override
  String get extractingAudio => '正在提取音轨…';
  @override
  String get transcodingAudio => '正在准备音频…';
  @override
  String get finalizingAttachment => '正在完成附件处理…';
  @override
  String get waitingForSpeechRecognition => '正在等待语音识别…';
  @override
  String get transcribingAudio => '正在进行语音识别…';
  @override
  String get understandingKeyframes => '正在理解关键帧…';
  @override
  String get recognizingText => '正在识别文本…';
  @override
  String get analyzingImage => '正在分析图片…';
  @override
  String get analyzingAttachment => '正在分析附件…';
}
...
class _StringsSettingsUpdateNoticeZhCn extends _StringsSettingsUpdateNoticeEn {
  ...
  @override
  String manualDownload({required Object version}) =>
      '发现新版本 ${version}，可下载 MSI 或打开发布页安装。';
}
...
class _StringsSettingsExternalImportZhCn
  ...
  @override
  String get chooseZipExport => '选择 zip 文件';
  @override
  ...
  @override
  String get title => '导入 Markdown 数据';
  @override
  String get introTitle => '只读导入通用 Markdown 数据';
  @override
  String get introBody =>
      '选择一个文件夹或 zip 文件后，系统会递归扫描其中的 Markdown 文件及其引用附件。导入后的内容仅参与检索，不会回写源数据。';
  @override
  String get sourceSectionTitle => '1. 选择 Markdown 导入源';
  @override
  ...
  String get error => '错误';
  @override
  String get importedBatches => 'Markdown 导入批次';
  @override
  String get noImportBatchesYet => '还没有 Markdown 导入批次。';
  @override
  ...
  @override
  String get importingTitle => '正在导入 Markdown 数据';
  @override
  ...
  @override
  String get reportTitle => 'Markdown 导入报告';
  @override
...
// Path: settings.knowledgeIndex
class _StringsSettingsKnowledgeIndexZhCn
    extends _StringsSettingsKnowledgeIndexEn {
  _StringsSettingsKnowledgeIndexZhCn._(_StringsZhCn root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get title => '知识索引';
  @override
  String get subtitle => '构建并诊断本地统一知识索引。';
  @override
  late final _StringsSettingsKnowledgeIndexStatusZhCn status =
      _StringsSettingsKnowledgeIndexStatusZhCn._(_root);
  @override
  late final _StringsSettingsKnowledgeIndexActionsZhCn actions =
      _StringsSettingsKnowledgeIndexActionsZhCn._(_root);
  @override
  String get versionSummaryUnavailable => '版本摘要不可用';
  @override
  String versionSummary(
          {required Object schema,
          required Object normalization,
          ...
          required Object embedding,
          required Object retrieval}) =>
      '版本 —— schema: ${schema}，normalization: ${normalization}，segmentation: ${segmentation}，embedding: ${embedding}，retrieval: ${retrieval}';
  @override
  String lastBuild({required Object value}) => '上次成功构建：${value}';
  @override
  String staleReason({required Object value}) => '过期原因：${value}';
  @override
  String lastError({required Object value}) => '最近错误：${value}';
  @override
  String progress(
          {required Object documentsIndexed,
          required Object totalDocuments,
          required Object unitsIndexed,
          required Object embeddingsIndexed}) =>
      '进度 —— 文档：${documentsIndexed}/${totalDocuments}，单元：${unitsIndexed}，向量：${embeddingsIndexed}';
  @override
  late final _StringsSettingsKnowledgeIndexDebugZhCn debug =
      _StringsSettingsKnowledgeIndexDebugZhCn._(_root);
}

// Path: settings.migrationArchive
class _StringsSettingsMigrationArchiveZhCn
    extends _StringsSettingsMigrationArchiveEn {
  _StringsSettingsMigrationArchiveZhCn._(_StringsZhCn root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get title => '迁移归档';
  @override
  String get subtitle => '导出可迁移 zip，或用归档覆盖恢复当前 Vault。';
  @override
  String get introTitle => '无损跨设备迁移';
  @override
  String get introBody =>
      '导出会生成一个包含 Markdown、附件和 manifest 元数据的 zip 归档。导入前会先创建本地回滚快照，然后清空当前 Vault，再恢复归档内容。';
  @override
  String get exportSectionTitle => '导出当前 Vault';
  @override
  String get exportDialogTitle => '保存迁移归档';
  @override
  String get exportAction => '导出 zip 归档';
  @override
  String get importSectionTitle => '导入迁移归档';
  @override
  String get importDialogTitle => '选择迁移归档';
  @override
  String get importPickArchive => '选择 zip 归档';
  @override
  String get importAction => '清空并导入归档';
  @override
  String get schemaVersion => 'Schema 版本';
  @override
  String get archiveItems => '事项数';
  @override
  String get archiveAttachments => '附件数';
  @override
  String get exportedAt => '导出时间';
  @override
  String get destructiveConfirmTitle => '我已知晓：会先清空当前 Vault 数据';
  @override
  String get destructiveConfirmBody =>
      '应用会先创建本地回滚快照，再删除当前 Vault 数据，然后导入所选归档。这不是合并导入。';
  @override
  String get progressTitle => '当前进度';
  @override
  String get progressOperation => '操作';
  @override
  String get progressStage => '阶段';
  @override
  String get progressStatus => '状态';
  @override
  String get progressStep => '步骤';
  @override
  String get operationExport => '导出';
  @override
  String get operationImport => '导入';
  @override
  String get statusInProgress => '进行中';
  @override
  String get statusCompleted => '已完成';
  @override
  String get statusRollback => '已回滚';
  @override
  String get stagePreparing => '准备归档';
  @override
  String get stageCollecting => '收集数据';
  @override
  String get stageWritingMarkdown => '写入 Markdown';
  @override
  String get stageCopyingAttachments => '复制附件';
  @override
  String get stageZipping => '生成 zip 归档';
  @override
  String get stageCompleted => '已完成';
  @override
  String get stageSnapshotCreated => '已创建回滚快照';
  @override
  String get stageVaultCleared => '已清空 Vault';
  @override
  String get stageBaseItemsRestored => '基础事项已恢复';
  @override
  String get stageAttachmentsRestored => '附件已恢复';
  @override
  String get stageRelationsRestored => '关联已恢复';
  @override
  String get stageReindexCompleted => '重建索引完成';
  @override
  String get stageRollback => '已完成回滚';
  @override
  String get archiveSize => '归档大小';
  @override
  String get confirmInputLabel => '输入 IMPORT 以继续';
  @override
  String get confirmInputHint => '请输入 IMPORT';
}
...
class _StringsSettingsAboutStatusZhCn extends _StringsSettingsAboutStatusEn {
  ...
  // Translations
  @override
  String get idle => '点击检查更新；Linux 可自动更新并重启，Windows 请手动安装 MSI 或打开发布页安装。';
  @override
  ...
  @override
  String availableExternal({required Object version}) =>
      '发现新版本（${version}）。请手动安装 MSI 或前往发布页安装。';
  @override
...
// Path: settings.knowledgeIndex.status
class _StringsSettingsKnowledgeIndexStatusZhCn
    extends _StringsSettingsKnowledgeIndexStatusEn {
  _StringsSettingsKnowledgeIndexStatusZhCn._(_StringsZhCn root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get loading => '状态：加载中…';
  @override
  String get empty => '状态：尚未构建';
  @override
  String get running => '状态：正在重建';
  @override
  String get stale => '状态：建议重建';
  @override
  String get failed => '状态：重建失败';
  @override
  String get cancelled => '状态：已取消重建';
  @override
  String get complete => '状态：已是最新';
}

// Path: settings.knowledgeIndex.actions
class _StringsSettingsKnowledgeIndexActionsZhCn
    extends _StringsSettingsKnowledgeIndexActionsEn {
  _StringsSettingsKnowledgeIndexActionsZhCn._(_StringsZhCn root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get rebuild => '重建索引';
  @override
  String get cancel => '取消重建';
}

// Path: settings.knowledgeIndex.debug
class _StringsSettingsKnowledgeIndexDebugZhCn
    extends _StringsSettingsKnowledgeIndexDebugEn {
  _StringsSettingsKnowledgeIndexDebugZhCn._(_StringsZhCn root)
      : this._root = root,
        super._(root);
  ...
  String indexedDocuments({required Object visible, required Object total}) =>
      '已索引文档（${visible}/${total}）';
  @override
  String get memorySynthesisTitle => '记忆合成';
  @override
  String get memorySynthesisBody => '生成记忆会保持在本地知识索引中，并以加密方式存储。';
  @override
  late final _StringsSettingsKnowledgeIndexDebugChipsZhCn chips =
      _StringsSettingsKnowledgeIndexDebugChipsZhCn._(_root);
  @override
  late final _StringsSettingsKnowledgeIndexDebugDetailZhCn detail =
      _StringsSettingsKnowledgeIndexDebugDetailZhCn._(_root);
}
...
class _StringsAttachmentsContentVideoInsightsDetailZhCn
  ...
  @override
  String groupedVideoHint({required Object count}) =>
      '${count} 个分段已归并为同一个逻辑视频条目。';
  @override
  String get derivedAssetsHint => '所有派生产物会继续归并在同一个视频条目下。';
}
...
// Path: settings.knowledgeIndex.debug.chips
class _StringsSettingsKnowledgeIndexDebugChipsZhCn
    extends _StringsSettingsKnowledgeIndexDebugChipsEn {
  _StringsSettingsKnowledgeIndexDebugChipsZhCn._(_StringsZhCn root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String total({required Object count}) => '总计 ${count}';
  @override
  String generated({required Object count}) => '生成记忆 ${count}';
  @override
  String source({required Object count}) => '源文档 ${count}';
  @override
  String summaries({required Object count}) => '摘要 ${count}';
  @override
  String preferences({required Object count}) => '偏好 ${count}';
  @override
  String profiles({required Object count}) => '用户画像 ${count}';
  @override
  String events({required Object count}) => '事件 ${count}';
  @override
  String patterns({required Object count}) => '模式 ${count}';
  @override
  String usageRows({required Object count}) => '使用记录 ${count}';
}

// Path: settings.knowledgeIndex.debug.detail
class _StringsSettingsKnowledgeIndexDebugDetailZhCn
    extends _StringsSettingsKnowledgeIndexDebugDetailEn {
  _StringsSettingsKnowledgeIndexDebugDetailZhCn._(_StringsZhCn root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String generatedMemoryRetrieval({required Object value}) => '生成记忆召回：${value}';
  @override
  String hotnessRerank({required Object value}) => '热度重排：${value}';
  @override
  String sessionDigest({required Object value}) => '会话摘要：${value}';
  @override
  String lastSynthesis({required Object value}) => '最近合成：${value}';
  @override
  String lastUsageUpdate({required Object value}) => '最近使用更新：${value}';
  @override
  String get on => '开启';
  @override
  String get off => '关闭';
...
extension on Translations {
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'attachments.content.videoInsights.detail.groupedVideoHint':
        return ({required Object count}) =>
            '${count} segments are grouped into one logical video entry.';
      case 'attachments.content.videoInsights.detail.derivedAssetsHint':
        return 'Derived assets stay grouped under the same video entry.';
      case 'attachments.content.videoInsights.fields.contentType':
        return 'Content type';
      case 'attachments.content.videoInsights.fields.segments':
        return 'Segments';
      case 'attachments.content.videoInsights.fields.keyframes':
        return 'Keyframes';
      case 'attachments.content.videoInsights.fields.truncated':
        return 'Truncated';
      case 'attachments.content.videoInsights.fields.summary':
        return 'Video summary';
      case 'attachments.content.emptyText':
        return 'None';
      case 'attachments.processing.preparingVideo':
        return 'Preparing video…';
      case 'attachments.processing.transcodingVideo':
        return 'Transcoding video…';
      case 'attachments.processing.generatingKeyframes':
        return 'Generating keyframes…';
      case 'attachments.processing.extractingAudio':
        return 'Extracting audio track…';
      case 'attachments.processing.transcodingAudio':
        return 'Preparing audio…';
      case 'attachments.processing.finalizingAttachment':
        return 'Finalizing attachment…';
      case 'attachments.processing.waitingForSpeechRecognition':
        return 'Waiting for speech recognition…';
      case 'attachments.processing.transcribingAudio':
        return 'Transcribing audio…';
      case 'attachments.processing.understandingKeyframes':
        return 'Understanding keyframes…';
      case 'attachments.processing.recognizingText':
        return 'Recognizing text…';
      case 'attachments.processing.analyzingImage':
        return 'Analyzing image…';
      case 'attachments.processing.analyzingAttachment':
        return 'Analyzing attachment…';
      ...
      case 'settings.about.status.idle':
        return 'Check for updates. Linux can auto-update and restart; Windows uses manual MSI or release-page install.';
      ...
      case 'settings.externalImport.title':
        return 'Import Markdown Data';
      case 'settings.externalImport.introTitle':
        return 'Readonly import for generic Markdown data';
      case 'settings.externalImport.introBody':
        return 'Choose a folder or zip file to recursively scan Markdown files and their referenced attachments. Imported content participates in retrieval only and never writes back to the source data.';
      case 'settings.externalImport.sourceSectionTitle':
        return '1. Choose Markdown import source';
      ...
      case 'settings.externalImport.importedBatches':
        return 'Markdown import batches';
      case 'settings.externalImport.noImportBatchesYet':
        return 'No Markdown import batches yet.';
      ...
      case 'settings.externalImport.importingTitle':
        return 'Importing Markdown data';
      ...
      case 'settings.externalImport.statusNoWork':
        return 'No work';
      case 'settings.knowledgeIndex.title':
        return 'Knowledge Index';
      case 'settings.knowledgeIndex.subtitle':
        return 'Build and diagnose the local unified knowledge index.';
      case 'settings.knowledgeIndex.status.loading':
        return 'Status: loading…';
      case 'settings.knowledgeIndex.status.empty':
        return 'Status: not built yet';
      case 'settings.knowledgeIndex.status.running':
        return 'Status: rebuilding';
      case 'settings.knowledgeIndex.status.stale':
        return 'Status: rebuild recommended';
      case 'settings.knowledgeIndex.status.failed':
        return 'Status: rebuild failed';
      case 'settings.knowledgeIndex.status.cancelled':
        return 'Status: rebuild cancelled';
      case 'settings.knowledgeIndex.status.complete':
        return 'Status: up to date';
      case 'settings.knowledgeIndex.actions.rebuild':
        return 'Rebuild index';
      case 'settings.knowledgeIndex.actions.cancel':
        return 'Cancel rebuild';
      case 'settings.knowledgeIndex.versionSummaryUnavailable':
        return 'Version summary unavailable';
      case 'settings.knowledgeIndex.versionSummary':
        return (
                {required Object schema,
                required Object normalization,
                required Object segmentation,
                ...
                required Object retrieval}) =>
            'Versions — schema: ${schema}, normalization: ${normalization}, segmentation: ${segmentation}, embedding: ${embedding}, retrieval: ${retrieval}';
      case 'settings.knowledgeIndex.lastBuild':
        return ({required Object value}) => 'Last successful build: ${value}';
      case 'settings.knowledgeIndex.staleReason':
        return ({required Object value}) => 'Stale reason: ${value}';
      case 'settings.knowledgeIndex.lastError':
        return ({required Object value}) => 'Last error: ${value}';
      case 'settings.knowledgeIndex.progress':
        return (
                {required Object documentsIndexed,
                required Object totalDocuments,
                required Object unitsIndexed,
                required Object embeddingsIndexed}) =>
            'Progress — documents: ${documentsIndexed}/${totalDocuments}, units: ${unitsIndexed}, embeddings: ${embeddingsIndexed}';
      case 'settings.knowledgeIndex.debug.indexedDocuments':
        return ({required Object visible, required Object total}) =>
            'Indexed documents (${visible}/${total})';
      case 'settings.knowledgeIndex.debug.memorySynthesisTitle':
        return 'Memory synthesis';
      case 'settings.knowledgeIndex.debug.memorySynthesisBody':
        return 'Generated memories stay local and encrypted inside the knowledge index.';
      case 'settings.knowledgeIndex.debug.chips.total':
        return ({required Object count}) => 'Total ${count}';
      case 'settings.knowledgeIndex.debug.chips.generated':
        return ({required Object count}) => 'Generated ${count}';
      case 'settings.knowledgeIndex.debug.chips.source':
        return ({required Object count}) => 'Source ${count}';
      case 'settings.knowledgeIndex.debug.chips.summaries':
        return ({required Object count}) => 'Summaries ${count}';
      case 'settings.knowledgeIndex.debug.chips.preferences':
        return ({required Object count}) => 'Preferences ${count}';
      case 'settings.knowledgeIndex.debug.chips.profiles':
        return ({required Object count}) => 'Profiles ${count}';
      case 'settings.knowledgeIndex.debug.chips.events':
        return ({required Object count}) => 'Events ${count}';
      case 'settings.knowledgeIndex.debug.chips.patterns':
        return ({required Object count}) => 'Patterns ${count}';
      case 'settings.knowledgeIndex.debug.chips.usageRows':
        return ({required Object count}) => 'Usage rows ${count}';
      case 'settings.knowledgeIndex.debug.detail.generatedMemoryRetrieval':
        return ({required Object value}) =>
            'Generated memory retrieval: ${value}';
      case 'settings.knowledgeIndex.debug.detail.hotnessRerank':
        return ({required Object value}) => 'Hotness rerank: ${value}';
      case 'settings.knowledgeIndex.debug.detail.sessionDigest':
        return ({required Object value}) => 'Session digest: ${value}';
      case 'settings.knowledgeIndex.debug.detail.lastSynthesis':
        return ({required Object value}) => 'Last synthesis: ${value}';
      case 'settings.knowledgeIndex.debug.detail.lastUsageUpdate':
        return ({required Object value}) => 'Last usage update: ${value}';
      case 'settings.knowledgeIndex.debug.detail.on':
        return 'on';
      case 'settings.knowledgeIndex.debug.detail.off':
        return 'off';
      case 'settings.migrationArchive.title':
        return 'Migration archive';
      case 'settings.migrationArchive.subtitle':
        return 'Export a portable zip or replace this vault from an archive.';
      case 'settings.migrationArchive.introTitle':
        return 'Lossless cross-device migration';
      case 'settings.migrationArchive.introBody':
        return 'Export the current vault as a zip archive with Markdown, attachments, and manifest metadata. Importing an archive first creates a local rollback snapshot, then clears the current vault before restoring the archive.';
      case 'settings.migrationArchive.exportSectionTitle':
        return 'Export current vault';
      case 'settings.migrationArchive.exportDialogTitle':
        return 'Save migration archive';
      case 'settings.migrationArchive.exportAction':
        return 'Export zip archive';
      case 'settings.migrationArchive.importSectionTitle':
        return 'Import migration archive';
      case 'settings.migrationArchive.importDialogTitle':
        return 'Choose migration archive';
      case 'settings.migrationArchive.importPickArchive':
        return 'Choose zip archive';
      case 'settings.migrationArchive.importAction':
        return 'Clear and import archive';
      case 'settings.migrationArchive.schemaVersion':
        return 'Schema version';
      case 'settings.migrationArchive.archiveItems':
        return 'Items';
      case 'settings.migrationArchive.archiveAttachments':
        return 'Attachments';
      case 'settings.migrationArchive.exportedAt':
        return 'Exported at';
      case 'settings.migrationArchive.destructiveConfirmTitle':
        return 'I understand this will clear current vault data first';
      case 'settings.migrationArchive.destructiveConfirmBody':
        return 'The app will create a local rollback snapshot, then delete current vault data before importing the selected archive. This is not a merge operation.';
      case 'settings.migrationArchive.progressTitle':
        return 'Current progress';
      case 'settings.migrationArchive.progressOperation':
        return 'Operation';
      case 'settings.migrationArchive.progressStage':
        return 'Stage';
      case 'settings.migrationArchive.progressStatus':
        return 'Status';
      case 'settings.migrationArchive.progressStep':
        return 'Step';
      case 'settings.migrationArchive.operationExport':
        return 'Export';
      case 'settings.migrationArchive.operationImport':
        return 'Import';
      case 'settings.migrationArchive.statusInProgress':
        return 'In progress';
      case 'settings.migrationArchive.statusCompleted':
        return 'Completed';
      case 'settings.migrationArchive.statusRollback':
        return 'Rollback';
      case 'settings.migrationArchive.stagePreparing':
        return 'Preparing archive';
      case 'settings.migrationArchive.stageCollecting':
        return 'Collecting data';
      case 'settings.migrationArchive.stageWritingMarkdown':
        return 'Writing Markdown';
      case 'settings.migrationArchive.stageCopyingAttachments':
        return 'Copying attachments';
      case 'settings.migrationArchive.stageZipping':
        return 'Creating zip archive';
      case 'settings.migrationArchive.stageCompleted':
        return 'Completed';
      case 'settings.migrationArchive.stageSnapshotCreated':
        return 'Rollback snapshot created';
      case 'settings.migrationArchive.stageVaultCleared':
        return 'Vault cleared';
      case 'settings.migrationArchive.stageBaseItemsRestored':
        return 'Base items restored';
      case 'settings.migrationArchive.stageAttachmentsRestored':
        return 'Attachments restored';
      case 'settings.migrationArchive.stageRelationsRestored':
        return 'Relations restored';
      case 'settings.migrationArchive.stageReindexCompleted':
        return 'Reindex completed';
      case 'settings.migrationArchive.stageRollback':
        return 'Rollback restored';
      case 'settings.migrationArchive.archiveSize':
        return 'Archive size';
      case 'settings.migrationArchive.confirmInputLabel':
        return 'Type IMPORT to continue';
      case 'settings.migrationArchive.confirmInputHint':
        return 'Enter IMPORT';
      case 'sync.title':
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'attachments.content.videoInsights.detail.extractedContent':
        return '提取内容';
      case 'attachments.content.videoInsights.detail.groupedVideoHint':
        return ({required Object count}) => '${count} 个分段已归并为同一个逻辑视频条目。';
      case 'attachments.content.videoInsights.detail.derivedAssetsHint':
        return '所有派生产物会继续归并在同一个视频条目下。';
      case 'attachments.content.videoInsights.fields.contentType':
        return '内容类型';
      case 'attachments.content.videoInsights.fields.segments':
        return '分段处理';
      ...
      case 'settings.about.status.idle':
        return '点击检查更新；Linux 可自动更新并重启，Windows 请手动安装 MSI 或打开发布页安装。';
      case 'settings.about.status.checking':
        return '正在检查更新…';
      case 'settings.about.status.upToDate':
        return '当前已是最新版本。';
      ...
      case 'settings.externalImport.importBatchDeleted':
        return '已删除导入批次';
      case 'settings.externalImport.title':
        return '导入 Markdown 数据';
      case 'settings.externalImport.introTitle':
        return '只读导入通用 Markdown 数据';
      case 'settings.externalImport.introBody':
        return '选择一个文件夹或 zip 文件后，系统会递归扫描其中的 Markdown 文件及其引用附件。导入后的内容仅参与检索，不会回写源数据。';
      case 'settings.externalImport.sourceSectionTitle':
        return '1. 选择 Markdown 导入源';
      case 'settings.externalImport.chooseFolder':
        return '选择文件夹';
      case 'settings.externalImport.chooseZip':
        return '选择 zip';
      ...
      case 'settings.externalImport.error':
        return '错误';
      case 'settings.externalImport.importedBatches':
        return 'Markdown 导入批次';
      case 'settings.externalImport.noImportBatchesYet':
        return '还没有 Markdown 导入批次。';
      case 'settings.externalImport.batchId':
        return '批次 ID';
      case 'settings.externalImport.createdAt':
        return '创建时间';
      ...
      case 'settings.knowledgeIndex.versionSummary':
        return (
            ...
            '版本 —— schema: ${schema}，normalization: ${normalization}，segmentation: ${segmentation}，embedding: ${embedding}，retrieval: ${retrieval}';
      case 'settings.knowledgeIndex.lastBuild':
        return ({required Object value}) => '上次成功构建：${value}';
      case 'settings.knowledgeIndex.staleReason':
        return ({required Object value}) => '过期原因：${value}';
      case 'settings.knowledgeIndex.lastError':
        return ({required Object value}) => '最近错误：${value}';
      case 'settings.knowledgeIndex.progress':
        return (
                {required Object documentsIndexed,
                required Object totalDocuments,
      ...
      case 'settings.knowledgeIndex.debug.memorySynthesisTitle':
        return '记忆合成';
      case 'settings.knowledgeIndex.debug.memorySynthesisBody':
        return '生成记忆会保持在本地知识索引中，并以加密方式存储。';
      case 'settings.knowledgeIndex.debug.chips.total':
        return ({required Object count}) => '总计 ${count}';
      case 'settings.knowledgeIndex.debug.chips.generated':
        return ({required Object count}) => '生成记忆 ${count}';
      case 'settings.knowledgeIndex.debug.chips.source':
        return ({required Object count}) => '源文档 ${count}';
      case 'settings.knowledgeIndex.debug.chips.summaries':
        return ({required Object count}) => '摘要 ${count}';
      case 'settings.knowledgeIndex.debug.chips.preferences':
        return ({required Object count}) => '偏好 ${count}';
      case 'settings.knowledgeIndex.debug.chips.profiles':
        return ({required Object count}) => '用户画像 ${count}';
      case 'settings.knowledgeIndex.debug.chips.events':
        return ({required Object count}) => '事件 ${count}';
      case 'settings.knowledgeIndex.debug.chips.patterns':
        return ({required Object count}) => '模式 ${count}';
      case 'settings.knowledgeIndex.debug.chips.usageRows':
        return ({required Object count}) => '使用记录 ${count}';
      case 'settings.knowledgeIndex.debug.detail.generatedMemoryRetrieval':
        return ({required Object value}) => '生成记忆召回：${value}';
      case 'settings.knowledgeIndex.debug.detail.hotnessRerank':
        return ({required Object value}) => '热度重排：${value}';
      case 'settings.knowledgeIndex.debug.detail.sessionDigest':
        return ({required Object value}) => '会话摘要：${value}';
      case 'settings.knowledgeIndex.debug.detail.lastSynthesis':
        return ({required Object value}) => '最近合成：${value}';
      case 'settings.knowledgeIndex.debug.detail.lastUsageUpdate':
        return ({required Object value}) => '最近使用更新：${value}';
      case 'settings.knowledgeIndex.debug.detail.on':
        return '开启';
      case 'settings.knowledgeIndex.debug.detail.off':
        return '关闭';
      case 'settings.migrationArchive.title':
        return '迁移归档';
      case 'settings.migrationArchive.subtitle':
        return '导出可迁移 zip，或用归档覆盖恢复当前 Vault。';
      case 'settings.migrationArchive.introTitle':
        return '无损跨设备迁移';
      case 'settings.migrationArchive.introBody':
        return '导出会生成一个包含 Markdown、附件和 manifest 元数据的 zip 归档。导入前会先创建本地回滚快照，然后清空当前 Vault，再恢复归档内容。';
      case 'settings.migrationArchive.exportSectionTitle':
        return '导出当前 Vault';
      case 'settings.migrationArchive.exportDialogTitle':
        return '保存迁移归档';
      ...
      case 'settings.migrationArchive.exportedAt':
        return '导出时间';
      case 'settings.migrationArchive.destructiveConfirmTitle':
        return '我已知晓：会先清空当前 Vault 数据';
      case 'settings.migrationArchive.destructiveConfirmBody':
        return '应用会先创建本地回滚快照，再删除当前 Vault 数据，然后导入所选归档。这不是合并导入。';
      case 'settings.migrationArchive.progressTitle':
        return '当前进度';
      case 'settings.migrationArchive.progressOperation':
        return '操作';
