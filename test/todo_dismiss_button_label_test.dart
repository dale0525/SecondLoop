...
void main() {
  ...
  testWidgets('Todo agenda status button toggles to in progress',
      (tester) async {
    final todo = Todo(
      id: 't1',
      title: 'Test todo',
    ...
    final statusButton =
        find.byKey(const ValueKey('todo_agenda_toggle_status_t1'));
    ...
    expect(backend.lastSetTodoStatusNewStatus, 'in_progress');
  });
