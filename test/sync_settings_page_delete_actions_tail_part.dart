...
void registerDeleteActionsTailTests() {
  testWidgets(
      'delete all data clears stale chat secretary memory cards after returning home',
      (tester) async {
    ...
    final backend = _ChatDeleteActionsBackend();
    ...
    expect(
      find.byKey(const ValueKey('secretary_memory_card_memory_source')),
      findsOneWidget,
    );

    await _scrollChatAwayFromBottom(tester);
    ...
    backend.completePendingMemoryProposalCreate();
    await tester.pumpAndSettle();
