...
void main() {
  ...
  test('keeps non-fallback logical key when repeated keydown reports fallback',
      () {
    final normalizer = MacOsKeyEventChannelNormalizer();
    ...
    final repeatedFallbackDownMessage = <String, Object?>{
      'keymap': 'macos',
      'type': 'keydown',
      'keyCode': 0,
      'modifiers': 0,
    ...
    normalizer.normalizeMessage(keyDownMessage);
    normalizer.normalizeMessage(repeatedFallbackDownMessage);
    final normalized = normalizer.normalizeMessage(keyUpMessage);
  ...
  test('keeps non-fallback logical key when KeyData repeat reports fallback',
      () {
    final normalizer = MacOsKeyDataNormalizer();
    ...
    normalizer.normalizeKeyData(downEvent);
    normalizer.normalizeKeyData(repeatEvent);
    final normalized = normalizer.normalizeKeyData(upEvent);
