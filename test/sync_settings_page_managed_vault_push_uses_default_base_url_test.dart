...
void main() {
  testWidgets('Managed vault Push uses default base URL', (tester) async {
    ...
    final backend = _CaptureManagedVaultPushBackend();
    ...
    expect(backend.lastVaultId, 'uid_1');
    expect(backend.lastIdToken, 'test-id-token');
  });
}

final class _CaptureManagedVaultPushBackend extends AppBackend {
  String? lastBaseUrl;
  String? lastVaultId;
  String? lastIdToken;
  ...
  Future<void> syncWebdavTestConnection(
      ...
      String? username,
      String? password,
      required String remoteRoot}) async {}
