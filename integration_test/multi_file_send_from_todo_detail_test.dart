...
void main() {
  testWidgets('Todo detail drop does not send before tapping send',
      (tester) async {
    final oldPlatform = debugDefaultTargetPlatformOverride;
    debugDefaultTargetPlatformOverride = TargetPlatform.macOS;
    try {
      final backend = _TodoDetailIntegrationBackend();
      ...
      expect(backend.linkTodoActivityCalls.length, 0);
      expect(backend.linkMessageCalls.length, 0);
  ...
  testWidgets('Todo detail keeps failed drafts for later retry',
      (tester) async {
    final oldPlatform = debugDefaultTargetPlatformOverride;
    debugDefaultTargetPlatformOverride = TargetPlatform.macOS;
    try {
...
final class _TodoDetailIntegrationBackend extends NativeAppBackend {
  _TodoDetailIntegrationBackend({
