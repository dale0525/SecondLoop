...
#[test]
fn ask_ai_prompt_enforces_reply_language_matches_user() {
    ...
    assert!(
        prompt.contains("Reply in the same language as the user's question"),
        "prompt missing language instruction: {prompt}"
    );
}
